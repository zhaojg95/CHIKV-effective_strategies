...
ess1 <- effectiveSize(mcmc_chain1);ess1
...
chain_beta_mp0 <- data.frame(i=rep(seq(1:16000),4),
...
chain_beta_pm0 <- data.frame(i=rep(seq(1:16000),4),
...
chain_k <- data.frame(i=rep(seq(1:16000),4),
...
ggsave(filename = "3.result/plot fig/Supplementary Fig. 20.png",p_trace,width = 13,height = 12,dpi = 1200,units = "cm")
...
ggsave(filename = "3.result/plot fig/Supplementary Fig. 21.png",density_bind_plot,width = 13,height =15,dpi = 1200,units = "cm")
...
ggsave(filename = "3.result/plot fig/Supplementary Fig. 1.png",p,width = 15,height = 7,dpi = 400,units = "cm")
